 ...
 * Prevents excessive requests to external platforms
 */
...
export const instagramRateLimiter = new RateLimiter(60000, 3); // 3 requests per minute
export const twitterRateLimiter = new RateLimiter(60000, 3); // 3 requests per minute
